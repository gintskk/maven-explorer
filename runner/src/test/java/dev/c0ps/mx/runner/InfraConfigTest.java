...
public class InfraConfigTest {
    ...
    @Test
    public void kafkaConnector_fastenNotReplacedInPlugin() {
        args.kafkaUrl = "u";
    ...
    @Test
    public void kafkaConnector_mavenExplorerPackageReplacedInPlugin() {
        args.kafkaUrl = "u";
        assertKafkaConnectorValues("dev.c0ps.mx.x.Y", //
                "u", "x.Y", null);
    }
